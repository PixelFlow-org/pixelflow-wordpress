    ...
    <>
      <div className="max-w-6xl py-3">
        <div className=" rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <section
            className={availableRoles.length > 0 ? 'mt-6 pt-6 border-t border-gray-200' : ''}
          >
            <h3 className="text-base font-semibold mb-2 !text-foreground">
            ...
            <p className="text-xs text-gray-600 mt-3 ml-11">
              {generalOptions.remove_on_uninstall === 1 ? (
                <>
                  ...
                  tracking scripts, and configurations will be permanently removed from your
                  database.
                </>
              ) : (
                <>
                ...
                <div className="mt-3 ml-11">
                  ...
                  <p className="text-xs mt-2">
                    {generalOptions.woo_debug_enabled === 1 ? (
                      ...
                      <>
                        Logging is off. Any previously recorded events are still available in the
                        log file above, if present.
                      </>
                    )}
                  </p>
                </div>
