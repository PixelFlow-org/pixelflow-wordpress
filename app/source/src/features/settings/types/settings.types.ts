...
export interface PixelFlowGeneralOptions {
  enabled: number;
  woo_enabled: number;
  woo_disable_add_to_cart: number; // Disable Add to Cart event for all products
  woo_disable_initiate_checkout: number; // Disable Initiate Checkout event for all products
  woo_disable_purchase: number; // Disable Purchase event for all products
